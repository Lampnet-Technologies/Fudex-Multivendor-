      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '3rem' }}>
        ...
        >
          <Box sx={{ width: '100%', marginBottom: '2rem' }}>
            <Typography component="label" htmlFor="name" sx={{ display: 'flex', justifyContent: 'flex-start', marginBottom: '0.5rem' }}>
              Name
            </Typography>
            <TextField id="name" variant="outlined" fullWidth required />
          </Box>
          <Box sx={{ width: '100%', marginBottom: '2rem' }}>
            <Typography component="label" htmlFor="email" sx={{ display: 'flex', justifyContent: 'flex-start', marginBottom: '0.5rem' }}>
              Email
            </Typography>
            <TextField id="email" variant="outlined" fullWidth required />
          </Box>
          <Box sx={{ width: '100%', marginBottom: '2rem' }}>
            <Typography component="label" htmlFor="phone" sx={{ display: 'flex', justifyContent: 'flex-start', marginBottom: '0.5rem' }}>
              Phone Number
            </Typography>
